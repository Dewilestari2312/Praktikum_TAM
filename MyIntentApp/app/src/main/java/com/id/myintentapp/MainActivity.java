        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.btn_move_activity_data:
                    ...
                    moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Dewi Lestari");
                ...
                case R.id.btn_move_activity_object:
                    ...
                    mPerson.setName("Dewi Lestari");
                    mPerson.setAge(19);
                    mPerson.setEmail("dewi.lestari1041@students.unila.ac.id");
                    mPerson.setCity("Bogor, Jawa Barat");
                ...
                case R.id.btn_dial_number:
                    String phoneNumber = "083160292994";
